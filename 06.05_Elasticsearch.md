...
COPY elasticsearch-8.3.2-linux-x86_64.tar.gz.sha512  /opt
RUN cd /opt && \
    ...
    rm elasticsearch-8.3.2-linux-x86_64.tar.gz elasticsearch-8.3.2-linux-x86_64.tar.gz.sha512 && \ 
    mkdir /var/lib/data && chmod -R 777 /var/lib/data && \
    chown -R elasticsearch_grp:elasticsearch_usr /opt/elasticsearch-8.3.2 && \
    yum clean all
